...
routes.get('/admin/users', (req, res, next) => adminController.getUsers(req, res, next));
routes.post('/admin/addUser', (req, res, next) => adminController.addUser(req, res, next));
routes.post('/admin/enableUser', (req, res, next) => adminController.enableUser(req, res, next));
routes.post('/admin/disableUser', (req, res, next) => adminController.disableUser(req, res, next));
